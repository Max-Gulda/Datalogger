...
#define START_MSG "%WV,0072,01%"
#define RUNNING_MSG "%WV,0072,02%"
#define STOP_MSG "%WV,0072,00%"

#define BLUETOOTH_START_MESSAGE "%WV,0072,01%"      //phone send string "start"
#define BLUETOOTH_STOP_MESSAGE  "%WV,0072,00%"        //phone send string "stop"

/* Filename should be at most 8 chars long and the extension should be at most 3 */
#define FILENAME "FINAP.CSV"
...
uint16_t finapressHandles[] = {
    finapressHandle_ADC_A0,
    finapressHandle_ADC_A1,
    finapressHandle_ADC_A2,
    finapressHandle_ADC_A3,
    finapressHandle_ADC_A4,
    finapressHandle_ADC_A5,
    finapressHandle_ADC_A6,
    finapressHandle_ADC_A7
};
